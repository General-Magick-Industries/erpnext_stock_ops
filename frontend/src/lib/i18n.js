...
const messages = {
  id: {
    ...
    form: {
      ...
      onlineOnly: '{doc} wajib dibuat saat online', onlineOnlyHint: '📶 Wajib online — hanya Permintaan Barang yang bisa dibuat offline.',
  ...
  en: {
    ...
    form: {
      ...
      onlineOnly: '{doc} must be created online', onlineOnlyHint: '📶 Online required — only Material Requests can be created offline.',
